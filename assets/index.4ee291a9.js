var se=Object.defineProperty,re=Object.defineProperties;var le=Object.getOwnPropertyDescriptors;var G=Object.getOwnPropertySymbols;var B=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable;var O=(t,i,o)=>i in t?se(t,i,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[i]=o,k=(t,i)=>{for(var o in i||(i={}))B.call(i,o)&&O(t,o,i[o]);if(G)for(var o of G(i))F.call(i,o)&&O(t,o,i[o]);return t},R=(t,i)=>re(t,le(i));var M=(t,i)=>{var o={};for(var a in t)B.call(t,a)&&i.indexOf(a)<0&&(o[a]=t[a]);if(t!=null&&G)for(var a of G(t))i.indexOf(a)<0&&F.call(t,a)&&(o[a]=t[a]);return o};import{r as g,u as ce,j as r,F as x,a as e,b as N,L as J,f as de,c as z,R as H,d as Q,e as P,g as v,h as b,i as C,k as _,l as K,m as W,n as w,o as he,p as ue,q as me,s as pe,S as ge,C as fe,t as be,v as we,w as ve,x as ye,y as $,z as ke,H as xe,A as Ie}from"./vendor.66af27ee.js";const Se=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const h of s)if(h.type==="childList")for(const f of h.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&a(f)}).observe(document,{childList:!0,subtree:!0});function o(s){const h={};return s.integrity&&(h.integrity=s.integrity),s.referrerpolicy&&(h.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?h.credentials="include":s.crossorigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function a(s){if(s.ep)return;s.ep=!0;const h=o(s);fetch(s.href,h)}};Se();var Ce="/assets/photo.df6c86e2.jpg";const Ae=({children:t,tooltip:i,placement:o="auto"})=>{const[a,s]=g.exports.useState(null),[h,f]=g.exports.useState(null),[y,A]=g.exports.useState(!1),I=()=>{A(!0)},T=()=>{A(!1)};g.exports.useEffect(()=>{a==null||a.addEventListener("mouseenter",I),a==null||a.addEventListener("mouseleave",T)},[a]);const[p,S]=g.exports.useState(null),{styles:q,attributes:ne}=ce(a,h,{placement:o,strategy:"fixed",modifiers:[{name:"arrow",options:{element:p}},{name:"flip",options:{fallbackPlacements:["bottom","right"]}}]});return r(x,{children:[e("button",{ref:s,children:t}),r("div",R(k({ref:f,style:q.popper},ne.popper),{className:`${y?"block":"hidden"} bg-black px-1 rounded-md z-10`,children:[i,e("div",{ref:S,style:q.arrow})]}))]})},U=({icon:t,tooltip:i,tooltipPlacement:o})=>e(Ae,{tooltip:i,placement:o,children:e(N,{icon:t,className:"text-white"})}),Te=(t,i)=>{let o;return()=>{o&&clearTimeout(o),o=setTimeout(()=>{o=void 0,t()},i)}},Re=()=>{const[t,i]=g.exports.useState(window.innerWidth);return g.exports.useEffect(()=>{const o=Te(function(){i(window.innerWidth)},500);return window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)}}),t},V=t=>e("span",{className:"inline-flex items-center justify-center px-4 py-1 mt-1 mr-2 font-bold text-md text-white bg-blue-600 rounded-full",children:t}),c=({value:t})=>e(X,{value:t,linkTo:"#"+t.replaceAll(" ","-").toLowerCase()}),X=({value:t,linkTo:i})=>i?e(J,{to:i,children:V(t)}):V(t),je=({techs:t})=>{const i=Re(),[o,a]=g.exports.useState(!1),s=o?t:Ne(t,i),h=()=>{a(!0)},f=()=>{a(!1)};return r("p",{className:"mt-2",children:[s.map(y=>e(X,{value:y},y)),t.length>s.length&&e("button",{className:"inline-flex items-center justify-center px-2 py-0.5 mt-1 text-sm text-white bg-blue-800 rounded-full",onClick:h,children:`+${t.length-s.length} more`}),o&&e("button",{className:"inline-flex items-center justify-center w-8 h-8 mt-1 text-sm text-white bg-blue-800 rounded-full",onClick:f,children:e(N,{icon:de})})]})},Ne=(t,i)=>{const o=i/25;let a=0;return t.filter(s=>(a+=s.length,a<o))},E={haveProvider:!1,hash:""},Y=g.exports.createContext(E),Pe=({children:t})=>{const[i,o]=g.exports.useState(E);return g.exports.useEffect(()=>{o(R(k({},E),{haveProvider:!0,setHash:a=>{o(s=>R(k({},s),{hash:a}))}}))},[o]),e(Y.Provider,{value:i,children:t})},Z=()=>g.exports.useContext(Y),ee=({id:t,children:i,hashProvider:o})=>{const a=g.exports.createRef(),s=h=>{if(h.hash===`#${t}`){const f=a.current;f&&f.scrollIntoView({behavior:"smooth"})}};return g.exports.useEffect(()=>{s(o)},[o]),e("div",{id:t,ref:a,children:i})},Le=t=>{const i=z();return e(ee,R(k({},t),{hashProvider:i}))};var l=t=>{const i=Z();return i.haveProvider?e(ee,R(k({},t),{hashProvider:i})):e(Le,k({},t))};const L=({value:t,children:i})=>e("h3",{className:"text-3xl text-center font-semibold pb-4 pt-12",children:t?e(l,{id:t.toLowerCase(),children:t}):i}),De=({value:t,children:i})=>e("h4",{className:"font-semibold text-lg mb-1",children:t?e(l,{id:t.toLowerCase(),children:t}):i}),Ge=new RegExp("^(http)|(https)://"),Me=t=>Ge.test(t.href||"")?e("a",k({target:"_blank",className:"dark:bg-green-900"},t)):e(J,{className:"dark:bg-green-900",to:t.href||"#",children:t.children}),n=({text:t,children:i})=>{const o={a:s=>{var a=M(s,[]);return e(Me,k({},a))}};return t?e(H,{components:o,className:"pb-4 max-w-prose mx-auto",children:t}):i&&e(H,{components:o,className:"pb-4 max-w-prose mx-auto",children:i})||e(x,{})},u=({title:t,text:i,icon:o,iconTooltip:a,techs:s,links:h,forceIcon:f=!1})=>r("div",{className:"bg-gray-900 p-4 rounded-xl mt-4 mr-auto shadow-md max-w-prose",children:[r("div",{className:"flex items-baseline",children:[e("div",{className:`${f||"md:hidden"} mr-2 mb-2`,children:e(U,{icon:o,tooltip:a,tooltipPlacement:"top"})}),e(De,{value:t})]}),e("p",{className:"leading-tight w-full",children:i}),h&&e(Je,{links:h}),s&&e(je,{techs:s})]}),Je=({links:t})=>r("div",{className:"px-1 pt-1",children:["see:",t.map(i=>r("a",{href:i.url,target:"_blank",className:"px-1 hover:bg-sky-700 whitespace-nowrap",children:["<",e(N,{icon:i.icon?i.icon:Q,className:"mr-1"}),e("span",{className:"underline",children:i.title}),">"]},i.url))]}),m=({children:t})=>e("div",{className:"col-span-1 mx-2",children:t}),Ke=()=>r("div",{className:"md:px-4 mx-1",children:[e(L,{value:"Pet Projects"}),e(n,{children:"A bunch of interesting tools and stuff I made for myself, others or just for fun. In my repositories you can find a lot of stuff that I tried, but here I list only the things that actually were done to some degree."}),r("div",{className:"md:grid grid-cols-2",children:[e(m,{children:e(u,{title:"mcp-k8s",text:"Model Context Protocol server for Kubernetes",icon:v,iconTooltip:"MCP Server",techs:["MCP","Golang","Kubernetes","OAuth2"],forceIcon:!0,links:[{url:"https://github.com/strowk/mcp-k8s-go",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"foxy-contexts",text:"Framework for Model Context Protocol servers built with Golang using fx",icon:C,iconTooltip:"Library",techs:["MCP","Golang"],forceIcon:!0,links:[{url:"https://github.com/strowk/foxy-contexts",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"sup",text:"Command line utility to streamline Trunk-Based-Development process when committing to git",icon:v,iconTooltip:"CLI Tool",techs:["Rust","Git"],forceIcon:!0,links:[{url:"https://github.com/strowk/sup",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"mcp-autotest",text:"Autotesting tool for MCP servers",icon:v,iconTooltip:"CLI Tool",techs:["MCP","Golang"],forceIcon:!0,links:[{url:"https://github.com/strowk/mcp-autotest",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"mcptee",text:"Logging tool to troubleshoot MCP servers when developing or testing",icon:v,iconTooltip:"CLI Tool",techs:["MCP","Golang"],forceIcon:!0,links:[{url:"https://github.com/strowk/mcptee",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"synf",text:"Hot reloading tool for quicker development of MCP servers",icon:v,iconTooltip:"CLI Tool",techs:["MCP","Rust"],forceIcon:!0,links:[{url:"https://github.com/strowk/synf",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"Compose for Git",text:"CLI tool and plugins to manage several local git repositories described in one yaml file",icon:v,iconTooltip:"CLI Tool",techs:["Golang","Git","VSCode Extension API","Typescript","GRPC"],forceIcon:!0})}),e(m,{children:e(u,{title:"trustmatrix",text:"Evolutionary simultaion of Prisoner's Dilemma",icon:v,iconTooltip:"Research Project",techs:["Kotlin","Game theory","Gitlab CI"],forceIcon:!0,links:[{url:"https://gitlab.com/strwrite/trustmatrix",title:"Repo",icon:_},{url:"https://strwrite.gitlab.io/trustmatrix/",title:"Demo",icon:Q}]})}),e(m,{children:e(u,{title:"probranchinator",text:"Display status of conflicts between git branches in terminal",icon:v,iconTooltip:"CLI Tool",techs:["Rust","clap-rs","Git"],forceIcon:!0,links:[{url:"https://github.com/strowk/probranchinator",title:"Repo",icon:b}]})}),e(m,{children:e(u,{title:"How to transform draw.io xml to picture in Gitlab CI",text:"",icon:v,iconTooltip:"Demo",techs:["React","Material UI"],forceIcon:!0,links:[{url:"https://gitlab.com/strwrite/drawio-gitlab-ci",title:"Repo",icon:_}]})})]}),e(L,{value:"Contributions"}),e(n,{children:"Features, bugfixes, libraries and tools contributed to already existing codebase or ecosystem."}),r("div",{className:"md:grid grid-cols-2",children:[e(m,{children:e(u,{title:"Play Seed",links:[{url:"https://ide.play-seed.dev/",title:"website"},{url:"https://docs.play-seed.dev/",title:"documentation",icon:C},{url:"https://github.com/MartinKavik/seed-app-todomvc/pull/2",title:"PR",icon:b}],text:"Interactive coding playground for Seed framework",icon:v,iconTooltip:"Project",techs:["Rust","seed-rs","Docker","Digital Ocean","traefik","Gitlab CI"],forceIcon:!0})}),e(m,{children:e(u,{title:"seed-icons",text:"Library with collections of icons for seed framework",links:[{url:"https://crates.io/crates/seed-icons",title:"crate",icon:C},{url:"https://strwrite.gitlab.io/seed-icons-browser/",title:"website"},{url:"https://github.com/seed-rs/awesome-seed-rs/pull/15",title:"PR",icon:b}],icon:C,iconTooltip:"Library",techs:["Rust","seed-rs","GraphQL"],forceIcon:!0})}),e(m,{children:e(u,{title:"arquillian-cube: multiple namespaces",text:"Support more than one namespace in one test",links:[{url:"https://github.com/arquillian/arquillian-cube/pull/872",title:"PR",icon:b}],icon:K,iconTooltip:"Feature",forceIcon:!0})}),e(m,{children:e(u,{title:"code-server: init containers",text:"Support extraInitContainers for helm chart",links:[{url:"https://github.com/coder/code-server/pull/3393",title:"PR",icon:b}],icon:K,iconTooltip:"Feature",forceIcon:!0})}),e(m,{children:e(u,{title:"jenkinsci/pipeline-aws-plugin: bugfix",text:"Fix wrong partition detection when assuming role",links:[{url:"https://github.com/jenkinsci/pipeline-aws-plugin/pull/251",title:"PR",icon:b}],icon:W,iconTooltip:"Bugfix",forceIcon:!0})}),e(m,{children:e(u,{title:"cypress-hmr-restarter: bugfix",text:"Fix wrong schema in url",links:[{url:"https://github.com/Svish/cypress-hmr-restarter/pull/13",title:"PR",icon:b}],icon:W,iconTooltip:"Bugfix",forceIcon:!0})})]}),e(L,{value:"Games"}),e(n,{children:"At some point I wanted to try myself in game design and development and made a bunch of games and libraries (like packages) on a platform known as Crayta and later in another one - dotbigbang."}),e(n,{children:"Crayta has been accessible in Stadia and in Epic Games, but facebook have bought and closed it. Game logic was implemented with Lua scripts, UI widgets on html/css/js with some specifics (Gameface engine)."}),e(n,{children:"These days sometimes I work on games and play in dotbigbang platform, where I use Typescript for game logic and UI."}),r("div",{className:"md:grid grid-cols-2",children:[e(m,{children:e(u,{title:"Laser Shot",text:"Simple multiplayer game where you control a small hovercraft with a laser cannon",icon:w,iconTooltip:"Game",techs:["Typescript"],forceIcon:!0,links:[{url:"https://dotbigbang.com/game/f213232ad9e543358b664b4931535a47/laser-shot?mp=f2132",title:"dotbigbang",icon:w}]})}),e(m,{children:e(u,{title:"Elysium Station Defense",text:"Single player game where you defend a space station from waves of enemies, while upgrading your spaceship",icon:w,iconTooltip:"Game",techs:["Typescript"],forceIcon:!0,links:[{url:"https://dotbigbang.com/game/5dc23f09a27f4b4fa83841f56d26c055/elysium-station-defense",title:"dotbigbang",icon:w}]})}),e(m,{children:e(u,{title:"Nuclear Gear Snake",text:"",icon:w,iconTooltip:"Game",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://craytak.it/crayta_games/3039",title:"CraytaKit",icon:w}]})}),e(m,{children:e(u,{title:"Flight and Fight",text:"",icon:w,iconTooltip:"Game",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://craytak.it/crayta_games/2281",title:"CraytaKit",icon:w}]})}),e(m,{children:e(u,{title:"Spellfire",text:"",icon:w,iconTooltip:"Game",techs:["Lua","Typescript","html","css","Javascript"],forceIcon:!0,links:[{url:"https://craytak.it/crayta_games/4213",title:"CraytaKit",icon:w}]})}),e(m,{children:e(u,{title:"Signs of Acryptica",text:"",icon:w,iconTooltip:"Game",techs:["Lua","Typescript","html","css","Javascript"],forceIcon:!0,links:[{url:"https://craytak.it/crayta_games/355",title:"CraytaKit",icon:w}]})}),e(m,{children:e(u,{title:"Radar",text:"",icon:C,iconTooltip:"Package",techs:["Lua","html","css","Javascript"],forceIcon:!0})}),e(m,{children:e(u,{title:"Superhex",text:"",icon:C,techs:["Lua","html","css","Javascript"],iconTooltip:"Package",forceIcon:!0})}),e(m,{children:e(u,{title:"TrackMouse",text:"",icon:C,iconTooltip:"Package",techs:["Lua","html","css","Javascript"],forceIcon:!0})}),e(m,{children:e(u,{title:"Holo Target Tracker",text:"",icon:C,iconTooltip:"Package",techs:["Lua","html","css","Javascript"],forceIcon:!0})})]})]});var We=P.memo(Ke);const Ee=t=>"type"in t&&t.type==="project",qe=({item:t})=>e(D,{item:t,icon:v,iconTooltip:"Project"}),Be=t=>"type"in t&&t.type==="upgrade",Fe=({item:t})=>e(D,{item:t,icon:K,iconTooltip:t.tooltip}),Oe=t=>"type"in t&&t.type==="graduation",ze=({item:t})=>e(D,{item:t,icon:he,iconTooltip:"Graduation"}),He=t=>"type"in t&&t.type==="newJob",Qe=({item:t})=>e(D,{item:t,icon:ue,iconTooltip:"New Job"}),_e=t=>"type"in t&&t.type==="finished",$e=({item:t})=>e(D,{item:t,icon:W,iconTooltip:"Finished"}),te=({date:t})=>r(x,{children:[e("span",{children:t.toLocaleString("en-us",{month:"short"})}),"\xA0",e("span",{children:t.getFullYear()})]});const Ue=()=>e("div",{className:"h-120p w-10 flex items-center justify-center",children:e("div",{className:"h-full w-1 bg-gray-900 pointer-events-none"})}),Ve=({icon:t,date:i,iconTooltip:o})=>r(x,{children:[e(Ue,{}),r("div",{className:"bg-gray-900 shadow text-center leading-10 absolute -left-1/2 top-11 rounded-l-md -mt-5 md:w-10 md:h-10 md:left-0 md:rounded-full",children:[i?e("div",{className:"px-4 md:hidden",children:e(te,{date:i})}):e("div",{className:"md:hidden rounded-full w-6 h-6 left-7 top-2 leading-10 bg-gray-900 shadow absolute"}),r("div",{className:"hidden md:block",children:[i&&e("div",{className:"md:-left-28 md:absolute",children:e(te,{date:i})}),e(U,{icon:t,tooltip:o,tooltipPlacement:"left"})]})]})]}),Xe=t=>"techs"in t,D=({item:t,icon:i,iconTooltip:o})=>{const a="hidden md:block";return r("div",{className:"flex md:contents",children:[e("div",{className:`${t.date?"":a} col-start-3 col-end-4 mr-10 ml-5 md:mx-auto relative`,children:e(Ve,{date:t.date,icon:i,iconTooltip:o})}),e("div",{className:"col-start-4 col-end-11",children:e(l,{id:t.title.toLowerCase().replaceAll(" ","-"),children:e(u,{title:t.title,text:t.text,icon:i,iconTooltip:o,techs:Xe(t)?t.techs:void 0})})})]})},Ye=({item:t})=>Ee(t)?e(qe,{item:t}):He(t)?e(Qe,{item:t}):Be(t)?e(Fe,{item:t}):Oe(t)?e(ze,{item:t}):_e(t)?e($e,{item:t}):e(x,{}),Ze=({items:t})=>e("div",{className:"container",children:e("div",{className:"flex flex-col md:grid grid-cols-12 text-gray-50",children:t.map(i=>e(Ye,{item:i},i.title+(i.date?i.date.toString():"")))})}),et=()=>e(Ze,{items:[{type:"project",title:"Smart Farming Data Exchange",text:"Simplified data exchange, reduced administrative workload, improving farm's profitability",techs:["Golang","PostgreSQL","Kafka","Kubernetes","AWS EKS","AWS CDK","Typescript","React","Next.js"]},{type:"project",title:"Facility Management",text:"Tracking of tickets to manage offices and other facilities",techs:["Typescript","Angular","NodeJS","Azure","Azure Devops","Kubernetes"]},{type:"upgrade",title:"Promoted to Senior Consultant",text:"",tooltip:"Promotion",date:new Date("2021-12-15")},{type:"project",title:"Electric Vehicles Charging Management",text:"Control of charging and battery analytics for fleets of fully electric buses and trucks",techs:["Kotlin","React","Typescript","AWS Fargate","AWS RDS Aurora","AWS Cloudformation","AWS Codepipeline","AWS Codebuild"]},{type:"project",title:"Vehicle Telemetry Collection",text:"Stream processing of telemetry from millions of cars",techs:["Scala","Akka","Kafka Streams","React","Javascript","AWS","Jenkins"]},{type:"upgrade",title:"Certified Kubernetes Administrator by CNCF",text:"CKA-2000-006435-0100 , scored 94%",tooltip:"Certification",date:new Date("2020-03-13")},{type:"project",title:"Smart City Analytics Platform",text:"Streaming data from integrations into data lake and real time analytics",techs:["Golang","RabbitMQ","Kafka","AWS S3","Gitlab"]},{type:"project",title:"City Traffic Control Platform",text:"Displaying live data from city traffic control system",techs:["React","Typescript","Java","Spring Boot","RabbitMQ","Kafka","Gitlab"]},{type:"project",title:"Streetlighting",text:"Central control of city smart streetlights infrastracture via LoraWAN",techs:["LoraWAN","Vue.js","Java","Spring Boot","RabbitMQ"]},{type:"newJob",title:"Concept Reply GmbH",text:"Started working as IoT Backend Developer (Consultant)",date:new Date("2019-03-01")},{type:"project",title:"Database as a Service",text:"Automated provision and maintenance of databases on-demand",techs:["Java","Spring Boot","Golang","Openshift/Kubernetes","Docker","Postgresql","MongoDB"]},{type:"project",title:"Digital Marketplace",text:"SAAS solution to sell automated digital services",techs:["Java","Spring Boot","Openshift/Kubernetes","Docker","Postgresql","Python"]},{type:"project",title:"Core Cloud Platform Automation",text:"Automated provision of services and integrations",techs:["Java","Spring Boot","Openshift/Kubernetes","Docker","Postgresql","Python","MongoDB"]},{type:"newJob",title:"Netcracker Technology Corp.",text:"Returned to work as a Senior Software Developer",date:new Date("2016-09-01")},{type:"newJob",title:"Mandatory military service",text:"Served as a Senior Computer Operator in science division",date:new Date("2015-06-29")},{type:"graduation",title:"Degree of Master of Applied Math and Physics",text:"Thesis: Selection of informative feature in the nolinear regression problem",date:new Date("2015-06-01")},{type:"project",title:"Telecom Operations and Management Solutions",text:"Operations support for internet service providers",techs:["Java EE","JDBC","Weblogic","Oracle SQL","plsql","Spring"]},{type:"newJob",title:"Netcracker Technology Corp.",text:"Started working as Java Software Developer",date:new Date("2013-08-01")},{type:"graduation",title:"Degree of Bachelor of Applied Math and Physics",text:"Thesis: Detection of biological signs in spectral analysis of a radio-electronic scan",date:new Date("2013-06-01")}]});var tt=P.memo(et);const it=()=>r("div",{className:"container mx-auto max-w-prose",children:[e(L,{children:"This site"}),e(n,{children:"This is resume as code written as a React SPA based on vite framework and using tailwind to style it."}),e(n,{children:"It is built with Github Actions and deployed to Github Pages, where it is distributed as a static site."}),e(n,{children:"I am mostly doing this for fun, but also to try these technologies while making something interesting. This is a primary way of learning for me - through making stuff."}),e(L,{children:"Me"}),e(n,{children:"I have been born in Russia, raised in regional capital and then have moved to Moscow for education. During university years I have started working as a software developer."}),e(n,{children:"After graduating with master degree from MIPT (Moscow Institute of Physics and Technology) I served one year in army and two years later moved to Germany, Munich, where I live presently."}),e(n,{children:"My mothertongue is Russian. I have learned English from books, documentation, films and work. I did learn a bit of Spanish in unversity and Japanese myself. Currently I am learning German."}),e(n,{children:"When possible, I prefer to learn technology by doing rather than going through tutorials, workshops, books, etc."}),e(n,{children:'When tech stack choice is available, I prefer tools, which reduce cognitive load as much as possible, while remain flexible. For example I would rather use strong statically typed programming language, because in the end IMO it helps to save a lot of "brain power" by preventing bugs through more clear structure of code and compiler checks.'}),e(n,{children:"I am not afraid of exploring new technologies and approaches if using them clearly improves the quality or other metrics of project success. However, I am driven by impact of my work and would rather choose [boring technology](https://mcfunley.com/choose-boring-technology) for the majority of cases over chasing shiny things. Say, for example, before chasing things like datalakes or super scalable nosql distributed databases, I would ask if the task could be faster and easier solved by good-old well understood SQL database."})]});var ot=P.memo(it);const at={mobile:0,tablet:768,desktop:1280},nt=({currentTab:t,tabs:i,setNavSwiper:o,moveToNextTab:a,moveToPreviousTab:s,moveToTab:h})=>{const{breakpoint:f}=me(at),y=f=="desktop",A=f=="tablet";return r("nav",{className:"px-4 flex flex-row text-4xl text-center font-semibold pb-8 border-b-4 border-gray-900",children:[e(ie,{onClick:()=>{s()},icon:pe}),e(ge,{modules:[fe],onSwiper:o,slidesPerView:y?3:A?2:1,children:i.map((I,T)=>e(be,{children:e(st,{onClick:()=>{h(T)},isCurrent:T===t,tab:I})},I.title))}),e(ie,{onClick:()=>{a()},icon:we})]})},st=({onClick:t,isCurrent:i,tab:o})=>e("button",{className:`font-semibold py-1 px-4 ${!i&&"text-gray-500"} rounded-md mt-2 transition ease-in-out delay-50 hover:-translate-y-1 hover:bg-indigo-500 hover:text-gray-100 duration-300`,onClick:t,children:e("h2",{className:`text-4xl font-semibold pb-2 border-b-4 ${i?"border-purple-500":"border-gray-900"}`,children:o.title})},o.title),ie=({onClick:t,icon:i})=>e("button",{className:"md:mx-4 w-16 h-16 text-gray-500 rounded-md transition ease-in-out delay-50 hover:-translate-y-1 hover:bg-indigo-500 hover:text-gray-100 duration-300",onClick:t,children:e(N,{icon:i})}),j=({children:t,name:i})=>r("div",{className:"my-2 bg-gray-50 dark:bg-gray-900 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 rounded-md",children:[e("dt",{className:"text-sm font-medium text-gray-500 dark:text-gray-100",children:i}),e("dd",{className:"mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2",children:t})]}),oe=`
...
`,ae=`I have been using Spring Boot in many projects, 
...
context once developer had included "starter" dependency.`,lt=()=>r(x,{children:[e(l,{id:"java",children:e(d,{title:"Java",children:e(n,{text:`
...
as well as some small interface with AWS (using AWS SSM Parameters to pass configs).
            `})})}),e(l,{id:"scala",children:e(d,{title:"Scala",children:e(n,{text:oe})})}),e(l,{id:"go",children:e(d,{title:"Golang",children:e(n,{text:`
...
I don't think my knowledge of Lua is very deep, though it is quite a simple language.
            `})})}),e(l,{id:"spring-boot",children:e(d,{title:"Spring Boot",children:e(n,{text:ae})})}),e(l,{id:"nestjs",children:e(d,{title:"NestJS",children:e(n,{text:`
...
availability testing of the whole deployment, which I found very convenient.
      `})})}),e(l,{id:"akka",children:e(d,{title:"Akka",children:e(n,{text:oe})})}),e(l,{id:"vue.js",children:e(d,{title:"vue.js",children:e(n,{text:`
...
interact with several of them.`})})})]}),d=({title:t,children:i})=>r(x,{children:[e("h3",{className:"text-center pt-5 pb-3 text-xl leading-6 font-medium text-gray-900 dark:text-gray-100",children:t}),i]});var ct=P.memo(lt);const dt=()=>r(x,{children:[r(j,{name:"Languages",children:[e(c,{value:"Java"}),e(c,{value:"Typescript"}),e(c,{value:"Kotlin"}),e(c,{value:"Scala"}),e(c,{value:"Go"}),e(c,{value:"Rust"}),e(c,{value:"Lua"})]}),r(j,{name:"Frameworks",children:[e(c,{value:"Spring Boot"}),e(c,{value:"React"}),e(c,{value:"Akka"}),e(c,{value:"vue.js"}),e(c,{value:"seed-rs"}),e(c,{value:"NestJS"})]}),r(j,{name:"Cloud",children:[e(c,{value:"Docker"}),e(c,{value:"AWS"}),e(c,{value:"Kubernetes"}),e(c,{value:"terraform"}),e(c,{value:"Cloudformation"}),e(c,{value:"CDK"})]}),r(j,{name:"Middleware",children:[e(c,{value:"Kafka"}),e(c,{value:"RabbitMQ"}),e(c,{value:"AWS IoT"}),e(c,{value:"Azure Servicebus"}),e(c,{value:"LoraWAN"})]}),r(j,{name:"CI/CD",children:[e(c,{value:"Gitlab"}),e(c,{value:"Jenkins"}),e(c,{value:"AWS Codepipeline"}),e(c,{value:"AWS Codebuild"})]}),r(j,{name:"Misc",children:[e(c,{value:"Redux"}),e(c,{value:"MobX"}),e(c,{value:"Cypress"}),e(c,{value:"Junit"}),e(c,{value:"scalatest"}),e(c,{value:"arquillian"})]}),e(n,{children:"This is not a complete list of technologies I have skills to work with, but just the ones most relevant. In a lot of situations I have found that having experience with similar tool is helping to quickly get used to another."}),e(ct,{})]}),ht=()=>{const t=[{title:"Tech",node:e("div",{className:"animate-fade-in bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4 pt-4",children:e(dt,{})},"tech-skills"),route:"/tech"},{title:"Timeline",node:e("div",{className:"animate-fade-in bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4",children:e(tt,{})},"history"),route:"/timeline"},{title:"Side Gigs",node:e("div",{className:"animate-fade-in bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4",children:e(We,{})},"side-gigs"),route:"/sides"},{title:"About",node:e("div",{className:"animate-fade-in bg-white dark:bg-gray-800 dark:text-gray-200 px-4 pb-4",children:e(ot,{})},"about"),route:"/about"}],[i,o]=g.exports.useState(0),[a,s]=g.exports.useState();return e(Pe,{children:e(ut,{currentTab:i,tabs:t,setNavSwiper:s,navSwiper:a,setCurrentTab:o})})},ut=({currentTab:t,tabs:i,setNavSwiper:o,navSwiper:a,setCurrentTab:s})=>{var T;const h=z(),f=ve(),y=Z(),A=p=>{(a==null?void 0:a.activeIndex)!==p&&(a==null||a.slideTo(p))};g.exports.useEffect(()=>{const p=i.findIndex(S=>S.route===h.pathname);p>=0&&p!==t&&(s(p),A(p)),y.hash!==h.hash&&y.setHash&&y.setHash(h.hash)},[h]),g.exports.useEffect(()=>{A(t)},[t]);const I=p=>{const S=i.at(p);S&&f(S.route)};return r(x,{children:[e(nt,{currentTab:t,moveToNextTab:()=>{const p=t+1;p<i.length&&I(p)},moveToPreviousTab:()=>{const p=t-1;p>=0&&I(p)},moveToTab:I,tabs:i,setNavSwiper:o}),r(ye,{children:[e($,{path:"/",element:(T=i.at(0))==null?void 0:T.node}),i.map((p,S)=>e($,{path:p.route,element:p.node},S))]})]})},mt=()=>r("section",{className:"p-6 rounded-tl-3xl bg-gray-800 overflow-x-clip",children:[e("h3",{className:"pt-5 pb-3 text-lg leading-6 font-medium text-gray-900 dark:text-gray-100",children:"Timur Sultanaev is"}),r("ul",{className:"list-disc list-inside text-gray-700 dark:text-gray-200",children:[e("li",{children:"a full-stack developer"}),e("li",{children:"who is focused on complete cycle of delivering cloud-based services"}),e("li",{children:"using DevOps practices and Agile methodology"}),e("li",{children:"with 12 years of working experience"}),e("li",{children:"currently living in Munich"})]}),e(l,{id:"contacts",children:r("div",{className:"mt-3 max-w-prose",children:["About all opportunities, job suggestions, etc, please contact me via LinkedIn only:",e("p",{children:r("a",{href:"https://www.linkedin.com/in/sultanaev-timur",target:"_blank",children:[e(N,{icon:ke})," ","www.linkedin.com/in/sultanaev-timur"]})})]})})]}),pt=i=>{var t=M(i,[]);return e("div",R(k({className:"bg-gray-50 dark:bg-gray-900"},t),{children:r("div",{className:"container mx-auto",children:[r("div",{className:"grid grid-flow-col md:grid-cols-3 grid-cols-2 bg-white dark:bg-gray-800",children:[e("div",{className:"col-start-1 row-span-1 col-span-1 rounded-br-3xl bg-gray-50 dark:bg-gray-900 hidden md:flex justify-center items-center",children:e("div",{className:"h-48 md:transition-[width] w-1 md:w-48",children:e("img",{className:"object-contain h-48 rounded-3xl",src:Ce})})}),e("div",{className:"dark:text-gray-200 md:col-start-2 col-span-2 col-start-1 bg-gray-900",children:e(mt,{})})]}),e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 md:pt-6 md:rounded-tl-3xl",children:e(ht,{})}),e("div",{children:e(J,{to:"#contacts",children:"Contacts"})})]})}))};function gt(){return e("div",{children:e(xe,{children:e(pt,{})})})}Ie.render(e(P.StrictMode,{children:e(gt,{})}),document.getElementById("root"));
