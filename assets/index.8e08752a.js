var re=Object.defineProperty,le=Object.defineProperties;var ce=Object.getOwnPropertyDescriptors;var K=Object.getOwnPropertySymbols;var H=Object.prototype.hasOwnProperty,Q=Object.prototype.propertyIsEnumerable;var U=(t,i,a)=>i in t?re(t,i,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[i]=a,y=(t,i)=>{for(var a in i||(i={}))H.call(i,a)&&U(t,a,i[a]);if(K)for(var a of K(i))Q.call(i,a)&&U(t,a,i[a]);return t},x=(t,i)=>le(t,ce(i));var B=(t,i)=>{var a={};for(var o in t)H.call(t,o)&&i.indexOf(o)<0&&(a[o]=t[o]);if(t!=null&&K)for(var o of K(t))i.indexOf(o)<0&&Q.call(t,o)&&(a[o]=t[o]);return a};import{r as m,u as de,j as r,F as w,a as e,b as P,L as J,f as he,c as C,d as z,R as _,e as I,g as N,h as L,i as O,k as F,l as V,m as v,n as ue,o as me,p as pe,q as ge,S as fe,C as be,s as ye,t as we,v as ve,w as ke,x as xe,y as Ie,H as Se,z as Ae,A as Te}from"./vendor.b7e8e7c7.js";const Ce=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const h of s)if(h.type==="childList")for(const u of h.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&o(u)}).observe(document,{childList:!0,subtree:!0});function a(s){const h={};return s.integrity&&(h.integrity=s.integrity),s.referrerpolicy&&(h.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?h.credentials="include":s.crossorigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function o(s){if(s.ep)return;s.ep=!0;const h=a(s);fetch(s.href,h)}};Ce();var Ne="/assets/photo.df6c86e2.jpg";const Re=({children:t,tooltip:i,placement:a="auto"})=>{const[o,s]=m.exports.useState(null),[h,u]=m.exports.useState(null),[b,k]=m.exports.useState(!1),S=()=>{k(!0)},A=()=>{k(!1)};m.exports.useEffect(()=>{o==null||o.addEventListener("mouseenter",S),o==null||o.addEventListener("mouseleave",A)},[o]);const[M,G]=m.exports.useState(null),{styles:E,attributes:j}=de(o,h,{placement:a,strategy:"fixed",modifiers:[{name:"arrow",options:{element:M}},{name:"flip",options:{fallbackPlacements:["bottom","right"]}}]});return r(w,{children:[e("button",{ref:s,children:t}),r("div",x(y({ref:u,style:E.popper},j.popper),{className:`${b?"block":"hidden"} bg-black px-1 rounded-md z-10`,children:[i,e("div",{ref:G,style:E.arrow})]}))]})},$=({icon:t,tooltip:i,tooltipPlacement:a})=>e(Re,{tooltip:i,placement:a,children:e(P,{icon:t,className:"text-white"})}),je=(t,i)=>{let a;return()=>{clearTimeout(a),a=setTimeout(o=>{a=void 0,t()},i)}},Pe=()=>{const[t,i]=m.exports.useState(window.innerWidth);return m.exports.useEffect(()=>{const a=je(function(){i(window.innerWidth)},500);return window.addEventListener("resize",a),()=>{window.removeEventListener("resize",a)}}),t},X=t=>e("span",{className:"inline-flex items-center justify-center px-4 py-1 mt-1 mr-2 font-bold text-md text-white bg-blue-600 rounded-full",children:t}),c=({value:t})=>e(Y,{value:t,linkTo:"#"+t.replaceAll(" ","-").toLowerCase()}),Y=({value:t,linkTo:i})=>i?e(J,{to:i,children:X(t)}):X(t),Le=({techs:t})=>{const i=Pe(),[a,o]=m.exports.useState(!1),s=a?t:De(t,i),h=()=>{o(!0)},u=()=>{o(!1)};return r("p",{className:"mt-2",children:[s.map(b=>e(Y,{value:b},b)),t.length>s.length&&e("button",{className:"inline-flex items-center justify-center px-2 py-0.5 mt-1 text-sm text-white bg-blue-800 rounded-full",onClick:h,children:`+${t.length-s.length} more`}),a&&e("button",{className:"inline-flex items-center justify-center w-8 h-8 mt-1 text-sm text-white bg-blue-800 rounded-full",onClick:u,children:e(P,{icon:he})})]})},De=(t,i)=>{const a=i/25;var o=0;return t.filter(s=>(o+=s.length,o<a))},g=({title:t,text:i,icon:a,iconTooltip:o,techs:s,links:h,forceIcon:u=!1})=>r("div",{className:"bg-gray-900 p-4 rounded-xl mt-4 mr-auto shadow-md max-w-prose",children:[r("div",{className:"flex items-baseline",children:[e("div",{className:`${u||"md:hidden"} mr-2 mb-2`,children:e($,{icon:a,tooltip:o,tooltipPlacement:"top"})}),e("h3",{className:"font-semibold text-lg mb-1",children:t})]}),e("p",{className:"leading-tight w-full",children:i}),h&&e(We,{links:h}),s&&e(Le,{techs:s})]}),We=({links:t})=>r("div",{className:"px-1 pt-1",children:["see:",t.map(i=>r("a",{href:i.url,target:"_blank",className:"px-1 hover:bg-sky-700 whitespace-nowrap",children:["<",e(P,{icon:i.icon?i.icon:C,className:"mr-1"}),e("span",{className:"underline",children:i.title}),">"]},i.url))]}),q={haveProvider:!1,hash:"",setHash:t=>{}},Z=m.exports.createContext(q),Me=({children:t})=>{const[i,a]=m.exports.useState(q);return m.exports.useEffect(()=>{a(x(y({},q),{haveProvider:!0,setHash:o=>{a(s=>x(y({},s),{hash:o}))}}))},[a]),e(Z.Provider,{value:i,children:t})},ee=()=>m.exports.useContext(Z),te=({id:t,children:i,hashProvider:a})=>{const o=m.exports.createRef(),s=h=>{if(h.hash===`#${t}`){let u=o.current;u&&(console.log("scrolling into ",h.hash),u.scrollIntoView({behavior:"smooth"}))}};return m.exports.useEffect(()=>{s(a)},[a]),e("div",{id:t,ref:o,children:i})},Ee=t=>{const i=z();return e(te,x(y({},t),{hashProvider:i}))};var l=t=>{const i=ee();return i.haveProvider?e(te,x(y({},t),{hashProvider:i})):e(Ee,y({},t))};const D=({value:t,children:i})=>e("h3",{className:"text-3xl text-center font-semibold pb-4 pt-12",children:t?e(l,{id:t.toLowerCase(),children:t}):i}),Ke=new RegExp("^(http)|(https)://"),Ge=t=>Ke.test(t.href||"")?e("a",y({target:"_blank",className:"dark:bg-green-900"},t)):e(J,{className:"dark:bg-green-900",to:t.href||"#",children:t.children}),n=({text:t,children:i})=>{const a={a:h=>{var u=h,{node:o}=u,s=B(u,["node"]);return e(Ge,y({},s))}};return t?e(_,{components:a,className:"pb-4 max-w-prose mx-auto",children:t}):i&&e(_,{components:a,className:"pb-4 max-w-prose mx-auto",children:i})||e(w,{})},f=({children:t})=>e("div",{className:"col-span-1 mx-2",children:t}),Be=()=>r("div",{className:"md:px-4 mx-1",children:[e(D,{value:"Contributions"}),e(n,{children:"Features, bugfixes, libraries and tools contributed to already existing codebase or ecosystem."}),r("div",{className:"md:grid grid-cols-2",children:[e(f,{children:e(g,{title:"Play Seed",links:[{url:"https://ide.play-seed.dev/",title:"website"},{url:"https://docs.play-seed.dev/",title:"documentation",icon:I},{url:"https://github.com/MartinKavik/seed-app-todomvc/pull/2",title:"PR",icon:N}],text:"Interactive coding playground for Seed framework",icon:L,iconTooltip:"Project",techs:["Rust","seed-rs","Docker","Digital Ocean","traefik","Gitlab CI"],forceIcon:!0})}),e(f,{children:e(g,{title:"seed-icons",text:"Library with collections of icons for seed framework",links:[{url:"https://crates.io/crates/seed-icons",title:"crate",icon:I},{url:"https://strwrite.gitlab.io/seed-icons-browser/",title:"website"},{url:"https://github.com/seed-rs/awesome-seed-rs/pull/15",title:"PR",icon:N}],icon:I,iconTooltip:"Library",techs:["Rust","seed-rs","GraphQL"],forceIcon:!0})}),e(f,{children:e(g,{title:"arquillian-cube: multiple namespaces",text:"Support more than one namespace in one test",links:[{url:"https://github.com/arquillian/arquillian-cube/pull/872",title:"PR",icon:N}],icon:O,iconTooltip:"Feature",forceIcon:!0})}),e(f,{children:e(g,{title:"code-server: init containers",text:"Support extraInitContainers for helm chart",links:[{url:"https://github.com/coder/code-server/pull/3393",title:"PR",icon:N}],icon:O,iconTooltip:"Feature",forceIcon:!0})}),e(f,{children:e(g,{title:"jenkinsci/pipeline-aws-plugin: bugfix",text:"Fix wrong partition detection when assuming role",links:[{url:"https://github.com/jenkinsci/pipeline-aws-plugin/pull/251",title:"PR",icon:N}],icon:F,iconTooltip:"Bugfix",forceIcon:!0})}),e(f,{children:e(g,{title:"cypress-hmr-restarter: bugfix",text:"Fix wrong schema in url",links:[{url:"https://github.com/Svish/cypress-hmr-restarter/pull/13",title:"PR",icon:N}],icon:F,iconTooltip:"Bugfix",forceIcon:!0})})]}),e(D,{value:"Pet Projects"}),e(n,{children:"A bunch of interesting tools and stuff I made for myself, others or just for fun. In my repositories you can find a lot of stuff that I tried, but here I list only the things that actually were done to some degree."}),r("div",{className:"md:grid grid-cols-2",children:[e(f,{children:e(g,{title:"Compose for Git",text:"CLI tool and plugins to manage several local git repositories described in one yaml file",icon:L,iconTooltip:"Project",techs:["Golang","Git","VSCode Extension API","Typescript","GRPC"],forceIcon:!0})}),e(f,{children:e(g,{title:"trustmatrix: Evolutionary simultaion of Prisoner's Dilemma",text:"",icon:L,iconTooltip:"Project",techs:["Kotlin","Game theory","Gitlab CI"],forceIcon:!0,links:[{url:"https://gitlab.com/strwrite/trustmatrix",title:"Repo",icon:V},{url:"https://strwrite.gitlab.io/trustmatrix/",title:"Demo",icon:C}]})}),e(f,{children:e(g,{title:"How to transform draw.io xml to picture in Gitlab CI",text:"",icon:L,iconTooltip:"Demo",techs:["React","Material UI"],forceIcon:!0,links:[{url:"https://gitlab.com/strwrite/drawio-gitlab-ci",title:"Repo",icon:V}]})})]}),e(D,{value:"Games"}),e(n,{children:"At some point I wanted to try myself in game design and development and made a bunch of games and libraries (like packages) on a platform known as Crayta. Crayta is accessible in Stadia and in Epic Games. Game logic is implemented with Lua scripts, UI widgets on html/css/js with some specifics (Gameface engine)."}),e(n,{children:"Source code is not available as a part of version control system, however all games in the list below could be remixed, which allows to create own copy with all the same code and configurations."}),r("div",{className:"md:grid grid-cols-2",children:[e(f,{children:e(g,{title:"Nuclear Gear Snake",text:"",icon:v,iconTooltip:"Game",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://play.crayta.com/games/752238b5-6db0-4ade-b26f-579be485b37a",title:"Crayta",icon:v}]})}),e(f,{children:e(g,{title:"Flight and Fight",text:"",icon:v,iconTooltip:"Game",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://play.crayta.com/games/266de510-225e-4f3d-94f8-cba7d067a12f",title:"Crayta",icon:v}]})}),e(f,{children:e(g,{title:"Spellfire",text:"",icon:v,iconTooltip:"Game",techs:["Lua","Typescript","html","css","Javascript"],forceIcon:!0,links:[{url:"https://play.crayta.com/games/e6766b4a-2eb8-4190-8e70-5729e0daf1aa",title:"Crayta",icon:v}]})}),e(f,{children:e(g,{title:"Signs of Acryptica",text:"",icon:v,iconTooltip:"Game",techs:["Lua","Typescript","html","css","Javascript"],forceIcon:!0,links:[{url:"https://play.crayta.com/games/a73b4699-3531-41ab-97aa-870802d6bf98",title:"Crayta",icon:v}]})}),e(f,{children:e(g,{title:"Radar",text:"",icon:I,iconTooltip:"Package",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://forum.crayta.com/t/radar/2847",title:"Crayta",icon:C}]})}),e(f,{children:e(g,{title:"Superhex",text:"",icon:I,techs:["Lua","html","css","Javascript"],iconTooltip:"Package",forceIcon:!0,links:[{url:"https://forum.crayta.com/t/superhex/1616",title:"Crayta",icon:C}]})}),e(f,{children:e(g,{title:"TrackMouse",text:"",icon:I,iconTooltip:"Package",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://forum.crayta.com/t/trackmouse/1491",title:"Crayta",icon:C}]})}),e(f,{children:e(g,{title:"Holo Target Tracker",text:"",icon:I,iconTooltip:"Package",techs:["Lua","html","css","Javascript"],forceIcon:!0,links:[{url:"https://forum.crayta.com/t/holo-target-tracker/1313",title:"Crayta",icon:C}]})})]})]}),Je=t=>"type"in t&&t.type==="project",Oe=({item:t})=>e(W,{item:t,icon:L,iconTooltip:"Project"}),Fe=t=>"type"in t&&t.type==="upgrade",qe=({item:t})=>e(W,{item:t,icon:O,iconTooltip:t.tooltip}),He=t=>"type"in t&&t.type==="graduation",Qe=({item:t})=>e(W,{item:t,icon:ue,iconTooltip:"Graduation"}),Ue=t=>"type"in t&&t.type==="newJob",ze=({item:t})=>e(W,{item:t,icon:me,iconTooltip:"New Job"}),_e=t=>"type"in t&&t.type==="finished",Ve=({item:t})=>e(W,{item:t,icon:F,iconTooltip:"Finished"}),ie=({date:t})=>r(w,{children:[e("span",{children:t.toLocaleString("en-us",{month:"short"})}),"\xA0",e("span",{children:t.getFullYear()})]});const $e=()=>e("div",{className:"h-120p w-10 flex items-center justify-center",children:e("div",{className:"h-full w-1 bg-gray-900 pointer-events-none"})}),Xe=({icon:t,date:i,iconTooltip:a})=>r(w,{children:[e($e,{}),r("div",{className:"bg-gray-900 shadow text-center leading-10 absolute -left-1/2 top-11 rounded-l-md -mt-5 md:w-10 md:h-10 md:left-0 md:rounded-full",children:[i?e("div",{className:"px-4 md:hidden",children:e(ie,{date:i})}):e("div",{className:"md:hidden rounded-full w-6 h-6 left-7 top-2 leading-10 bg-gray-900 shadow absolute"}),r("div",{className:"hidden md:block",children:[i&&e("div",{className:"md:-left-28 md:absolute",children:e(ie,{date:i})}),e($,{icon:t,tooltip:a,tooltipPlacement:"left"})]})]})]}),Ye=t=>"techs"in t,W=({item:t,icon:i,iconTooltip:a})=>{let o="hidden md:block";return r("div",{className:"flex md:contents",children:[e("div",{className:`${t.date?"":o} col-start-3 col-end-4 mr-10 ml-5 md:mx-auto relative`,children:e(Xe,{date:t.date,icon:i,iconTooltip:a})}),e("div",{className:"col-start-4 col-end-11",children:e(l,{id:t.title.toLowerCase().replaceAll(" ","-"),children:e(g,{title:t.title,text:t.text,icon:i,iconTooltip:a,techs:Ye(t)?t.techs:void 0})})})]})},Ze=({item:t})=>Je(t)?e(Oe,{item:t}):Ue(t)?e(ze,{item:t}):Fe(t)?e(qe,{item:t}):He(t)?e(Qe,{item:t}):_e(t)?e(Ve,{item:t}):e(w,{}),et=({items:t})=>e("div",{className:"container",children:e("div",{className:"flex flex-col md:grid grid-cols-12 text-gray-50",children:t.map(i=>e(Ze,{item:i},i.title+(i.date?i.date.toString():"")))})}),tt=()=>e(et,{items:[{type:"upgrade",title:"Promoted to Senior Consultant",text:"",tooltip:"Promotion",date:new Date("2021-12-15")},{type:"project",title:"Electric Vehicles Charging Management",text:"Control of charging and battery analytics for fleets of fully electric buses and trucks",techs:["Kotlin","React","Typescript","AWS Fargate","AWS RDS Aurora","AWS Cloudformation","AWS Codepipeline","AWS Codebuild"]},{type:"project",title:"Vehicle Telemetry Collection",text:"Stream processing of telemetry from millions of cars",techs:["Scala","Akka","Kafka Streams","React","Javascript"]},{type:"upgrade",title:"Certified Kubernetes Administrator by CNCF",text:"CKA-2000-006435-0100 , scored 94%",tooltip:"Certification",date:new Date("2020-03-13")},{type:"project",title:"Smart City Analytics Platform",text:"Streaming data from integrations into data lake and real time analytics",techs:["Golang","RabbitMQ","Kafka","AWS S3"]},{type:"project",title:"City Traffic Control Platform",text:"Displaying live data from city traffic control system",techs:["React","Typescript","Java","Spring Boot","RabbitMQ","Kafka"]},{type:"project",title:"Streetlighting",text:"Central control of city smart streetlights infrastracture via LoraWAN",techs:["LoraWAN","Vue.js","Java","Spring Boot","RabbitMQ"]},{type:"newJob",title:"Concept Reply GmbH",text:"Started working as IoT Backend Developer (Consultant)",date:new Date("2019-03-01")},{type:"project",title:"Database as a Service",text:"Automated provision and maintenance of databases on-demand",techs:["Java","Spring Boot","Golang","Openshift/Kubernetes","Docker","Postgresql","MongoDB"]},{type:"project",title:"Digital Marketplace",text:"SAAS solution to sell automated digital services",techs:["Java","Spring Boot","Openshift/Kubernetes","Docker","Postgresql","Python"]},{type:"project",title:"Core Cloud Platform Automation",text:"Automated provision of services and integrations",techs:["Java","Spring Boot","Openshift/Kubernetes","Docker","Postgresql","Python","MongoDB"]},{type:"newJob",title:"Netcracker Technology Corp.",text:"Returned to work as a Senior Software Developer",date:new Date("2016-09-01")},{type:"newJob",title:"Mandatory military service",text:"Served as a Senior Computer Operator in science division",date:new Date("2015-06-29")},{type:"graduation",title:"Degree of Master of Applied Math and Physics",text:"Thesis: Selection of informative feature in the nolinear regression problem",date:new Date("2015-06-01")},{type:"project",title:"Telecom Operations and Management Solutions",text:"Operations support for internet service providers",techs:["Java EE","JDBC","Weblogic","Oracle SQL","plsql","Spring"]},{type:"newJob",title:"Netcracker Technology Corp.",text:"Started working as Java Software Developer",date:new Date("2013-08-01")},{type:"graduation",title:"Degree of Bachelor of Applied Math and Physics",text:"Thesis: Detection of biological signs in spectral analysis of a radio-electronic scan",date:new Date("2013-06-01")}]});const it=()=>r("div",{className:"container mx-auto max-w-prose",children:[e(D,{children:"This site"}),e(n,{children:"This is resume as code written as a React SPA based on vite framework and using tailwind to style it."}),e(n,{children:"It is built with Github Actions and deployed to Github Pages, where it is distributed as a static site."}),e(n,{children:"I am mostly doing this for fun, but also to try these technologies while making something interesting. This is a primary way of learning for me - through making stuff."}),e(D,{children:"Me"}),e(n,{children:"I have been born in Russia, raised in regional capital and then have moved to Moscow for education. During university years I have started working as a software developer."}),e(n,{children:"After graduating with master degree from MIPT (Moscow Institute of Physics and Technology) I served one year in army and two years later moved to Germany, Munich, where I live presently."}),e(n,{children:"My mothertongue is Russian. I have learned English from books, documentation, films and work. I did learn a bit of Spanish in unversity and Japanese myself. Currently I am learning German."}),e(n,{children:"When possible, I prefer to learn technology by doing rather than going through tutorials, workshops, books, etc."}),e(n,{children:'When tech stack choice is available, I prefer tools, which reduce cognitive load as much as possible, while remain flexible. For example I would rather use strong statically typed programming language, because in the end IMO it helps to save a lot of "brain power" by preventing bugs through more clear structure of code and compiler checks.'}),e(n,{children:"I am not afraid of exploring new technologies and approaches if using them clearly improves the quality or other metrics of project success. However, I am driven by impact of my work and would rather choose [boring technology](https://mcfunley.com/choose-boring-technology) for the majority of cases over chasing shiny things. Say, for example, before chasing things like datalakes or super scalable nosql distributed databases, I would ask if the task could be faster and easier solved by good-old well understood SQL database."})]}),at={mobile:0,tablet:768,desktop:1280},ot=({currentTab:t,tabs:i,setNavSwiper:a,moveToNextTab:o,moveToPreviousTab:s,moveToTab:h})=>{const{breakpoint:u}=pe(at),b=u=="desktop",k=u=="tablet";return r("nav",{className:"px-4 flex flex-row text-4xl text-center font-semibold pb-8 border-b-4 border-gray-900",children:[e(ae,{onClick:()=>{s()},icon:ge}),e(fe,{modules:[be],onSwiper:a,slidesPerView:b?3:k?2:1,children:i.map((S,A)=>e(ye,{children:e(nt,{onClick:()=>{h(A)},isCurrent:A===t,tab:S})},S.title))}),e(ae,{onClick:()=>{o()},icon:we})]})},nt=({onClick:t,isCurrent:i,tab:a})=>e("button",{className:`font-semibold py-1 px-4 ${!i&&"text-gray-500"} rounded-md transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 hover:text-gray-100 duration-300`,onClick:t,children:e("h2",{className:`text-4xl font-semibold pb-2 border-b-4 ${i?"border-purple-500":"border-gray-900"}`,children:a.title})},a.title),ae=({onClick:t,icon:i})=>e("button",{className:"md:mx-4 w-16 h-16 text-gray-500 rounded-md transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 hover:text-gray-100 duration-300",onClick:t,children:e(P,{icon:i})}),R=({children:t,name:i})=>r("div",{className:"my-2 bg-gray-50 dark:bg-gray-900 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 rounded-md",children:[e("dt",{className:"text-sm font-medium text-gray-500 dark:text-gray-100",children:i}),e("dd",{className:"mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2",children:t})]}),oe=`
...
`,ne=`I have been using Spring Boot in many projects, 
...
context once developer had included "starter" dependency.`,rt=()=>r(w,{children:[e(l,{id:"java",children:e(d,{title:"Java",children:e(n,{text:`
...
You could see all published [games I have made here](https://play.crayta.com/users/e4f7b13e-fcdc-423e-9544-e1f6a6272862).
            `})})}),e(l,{id:"spring-boot",children:e(d,{title:"Spring Boot",children:e(n,{text:ne})})}),e(l,{id:"react",children:e(d,{title:"React",children:e(n,{text:`
...
`})})}),e(l,{id:"lorawan",children:e(d,{title:"LoraWAN",children:e(n,{text:"TBU"})})}),e(l,{id:"gitlab",children:e(d,{title:"Gitlab",children:e(n,{text:"TBU"})})}),e(l,{id:"jenkins",children:e(d,{title:"Jenkins",children:e(n,{text:"TBU"})})}),e(l,{id:"aws-codepipeline",children:e(d,{title:"AWS Codepipeline",children:e(n,{text:"TBU"})})}),e(l,{id:"aws-codebuild",children:e(d,{title:"AWS Codebuild",children:e(n,{text:"TBU"})})}),e(l,{id:"redux",children:e(d,{title:"Redux",children:e(n,{text:"TBU"})})}),e(l,{id:"mobx",children:e(d,{title:"MobX",children:e(n,{text:"TBU"})})}),e(l,{id:"cypress",children:e(d,{title:"Cypress",children:e(n,{text:"TBU"})})}),e(l,{id:"junit",children:e(d,{title:"Junit",children:e(n,{text:"TBU"})})}),e(l,{id:"scalatest",children:e(d,{title:"Scalatest",children:e(n,{text:"TBU"})})}),e(l,{id:"arquillian",children:e(d,{title:"Arquillian",children:e(n,{text:"TBU"})})})]}),d=({title:t,children:i})=>r(w,{children:[e("h3",{className:"text-center pt-5 pb-3 text-xl leading-6 font-medium text-gray-900 dark:text-gray-100",children:t}),i]}),lt=()=>r(w,{children:[r(R,{name:"Languages",children:[e(c,{value:"Java"}),e(c,{value:"Typescript"}),e(c,{value:"Kotlin"}),e(c,{value:"Scala"}),e(c,{value:"Go"}),e(c,{value:"Rust"}),e(c,{value:"Lua"})]}),r(R,{name:"Frameworks",children:[e(c,{value:"Spring Boot"}),e(c,{value:"React"}),e(c,{value:"Akka"}),e(c,{value:"vue.js"}),e(c,{value:"seed-rs"})]}),r(R,{name:"Cloud",children:[e(c,{value:"Docker"}),e(c,{value:"AWS"}),e(c,{value:"Kubernetes"}),e(c,{value:"terraform"}),e(c,{value:"Cloudformation"}),e(c,{value:"CDK"})]}),r(R,{name:"Middleware",children:[e(c,{value:"Kafka"}),e(c,{value:"RabbitMQ"}),e(c,{value:"AWS IoT"}),e(c,{value:"LoraWAN"})]}),r(R,{name:"CI/CD",children:[e(c,{value:"Gitlab"}),e(c,{value:"Jenkins"}),e(c,{value:"AWS Codepipeline"}),e(c,{value:"AWS Codebuild"})]}),r(R,{name:"Misc",children:[e(c,{value:"Redux"}),e(c,{value:"MobX"}),e(c,{value:"Cypress"}),e(c,{value:"Junit"}),e(c,{value:"scalatest"}),e(c,{value:"arquillian"})]}),e(n,{children:"This is not a complete list of technologies I have skills to work with, but just the ones most recent/relevant. In a lot of situations I have found that having experience with similar tool is helping to quickly get used to another."}),e(rt,{})]}),ct=()=>{const t=[{title:"Tech",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4 pt-4",children:e(lt,{})}),route:"/tech"},{title:"Timeline",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4",children:e(tt,{})}),route:"/timeline"},{title:"Open Source",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4",children:e(Be,{})}),route:"/open-source"},{title:"About",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-4 pb-4",children:e(it,{})}),route:"/about"}],[i,a]=m.exports.useState(0),[o,s]=m.exports.useState(),[h,u]=m.exports.useState();return e(Me,{children:e(dt,{currentTab:i,swiper:h,tabs:t,setNavSwiper:s,navSwiper:o,setSwiper:u,setCurrentTab:a})})},dt=({currentTab:t,swiper:i,tabs:a,setNavSwiper:o,navSwiper:s,setSwiper:h,setCurrentTab:u})=>{const b=z(),k=ve(),[S,A]=m.exports.useState(!1),M=ee();m.exports.useEffect(()=>{if(!S){A(!0);return}let p=a[t];b.pathname!==p.route&&k(p.route)},[t]);const G=()=>{M.hash!==b.hash&&M.setHash(b.hash)},E=p=>{console.log(`nav is ${b.pathname}`);let T=a.findIndex(se=>se.route==b.pathname);T>=0&&t!==T?p==null||p.slideTo(T):G()};m.exports.useEffect(()=>{E(i)},[i,b]);const j=p=>{const T=a.at(p);T&&(k(T.route),u(p),s==null||s.slideTo(p))};return r(w,{children:[e(ot,{currentTab:t,moveToNextTab:()=>{const p=t+1;p<a.length&&j(p)},moveToPreviousTab:()=>{const p=t-1;p>=0&&j(p)},moveToTab:j,tabs:a,setNavSwiper:o}),e(ke,{children:a.map(p=>e(xe,{path:p.route,element:p.node}))})]})},ht=()=>r("section",{className:"p-6 rounded-tl-3xl bg-gray-800 overflow-x-clip",children:[e("h3",{className:"pt-5 pb-3 text-lg leading-6 font-medium text-gray-900 dark:text-gray-100",children:"Timur Sultanaev is"}),r("ul",{className:"list-disc list-inside text-gray-700 dark:text-gray-200",children:[e("li",{children:"a full-stack developer"}),e("li",{children:", who is focused on complete cycle of delivering cloud-based services"}),e("li",{children:"using DevOps practices and Agile methodology"}),e("li",{children:", with 8 years of working experience"}),e("li",{children:". Currently living in Munich (Germany)"}),e("li",{children:", not looking for a job change"})]}),e(l,{id:"contacts",children:r("div",{className:"mt-3 max-w-prose",children:["About all opportunities, job suggestions, etc, please contact me via LinkedIn only:",e("p",{children:r("a",{href:"https://www.linkedin.com/in/sultanaev-timur",target:"_blank",children:[e(P,{icon:Ie})," ","www.linkedin.com/in/sultanaev-timur"]})})]})})]}),ut=i=>{var t=B(i,[]);return e("div",x(y({className:"bg-gray-50 dark:bg-gray-900"},t),{children:r("div",{className:"container mx-auto",children:[r("div",{className:"grid grid-flow-col md:grid-cols-3 grid-cols-2 bg-white dark:bg-gray-800",children:[e("div",{className:"col-start-1 row-span-1 col-span-1 rounded-br-3xl bg-gray-50 dark:bg-gray-900 hidden md:flex justify-center items-center",children:e("div",{className:"h-48 md:transition-[width] w-1 md:w-48",children:e("img",{className:"object-contain h-48 rounded-3xl",src:Ne})})}),e("div",{className:"dark:text-gray-200 md:col-start-2 col-span-2 col-start-1 bg-gray-900",children:e(ht,{})})]}),e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 md:pt-6 md:rounded-tl-3xl",children:e(ct,{})}),e("div",{children:e(J,{to:"#contacts",children:"Contacts"})})]})}))};function mt(){return e("div",{children:e(Se,{children:e(ut,{})})})}Ae.render(e(Te.StrictMode,{children:e(mt,{})}),document.getElementById("root"));
