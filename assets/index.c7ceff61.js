...
`})})}),e(l,{id:"lorawan",children:e(d,{title:"LoraWAN",children:e(n,{text:"TBU"})})}),e(l,{id:"gitlab",children:e(d,{title:"Gitlab",children:e(n,{text:"TBU"})})}),e(l,{id:"jenkins",children:e(d,{title:"Jenkins",children:e(n,{text:"TBU"})})}),e(l,{id:"aws-codepipeline",children:e(d,{title:"AWS Codepipeline",children:e(n,{text:"TBU"})})}),e(l,{id:"aws-codebuild",children:e(d,{title:"AWS Codebuild",children:e(n,{text:"TBU"})})}),e(l,{id:"redux",children:e(d,{title:"Redux",children:e(n,{text:"TBU"})})}),e(l,{id:"mobx",children:e(d,{title:"MobX",children:e(n,{text:"TBU"})})}),e(l,{id:"cypress",children:e(d,{title:"Cypress",children:e(n,{text:"TBU"})})}),e(l,{id:"junit",children:e(d,{title:"Junit",children:e(n,{text:"TBU"})})}),e(l,{id:"scalatest",children:e(d,{title:"Scalatest",children:e(n,{text:"TBU"})})}),e(l,{id:"arquillian",children:e(d,{title:"Arquillian",children:e(n,{text:"TBU"})})})]}),d=({title:t,children:i})=>s(v,{children:[e("h3",{className:"text-center pt-5 pb-3 text-xl leading-6 font-medium text-gray-900 dark:text-gray-100",children:t}),i]}),st=()=>s(v,{children:[s(C,{name:"Languages",children:[e(c,{value:"Java"}),e(c,{value:"Typescript"}),e(c,{value:"Kotlin"}),e(c,{value:"Scala"}),e(c,{value:"Go"}),e(c,{value:"Rust"}),e(c,{value:"Lua"})]}),s(C,{name:"Frameworks",children:[e(c,{value:"Spring Boot"}),e(c,{value:"React"}),e(c,{value:"Akka"}),e(c,{value:"vue.js"}),e(c,{value:"seed-rs"})]}),s(C,{name:"Cloud",children:[e(c,{value:"Docker"}),e(c,{value:"AWS"}),e(c,{value:"Kubernetes"}),e(c,{value:"terraform"}),e(c,{value:"Cloudformation"}),e(c,{value:"CDK"})]}),s(C,{name:"Middleware",children:[e(c,{value:"Kafka"}),e(c,{value:"RabbitMQ"}),e(c,{value:"AWS IoT"}),e(c,{value:"LoraWAN"})]}),s(C,{name:"CI/CD",children:[e(c,{value:"Gitlab"}),e(c,{value:"Jenkins"}),e(c,{value:"AWS Codepipeline"}),e(c,{value:"AWS Codebuild"})]}),s(C,{name:"Misc",children:[e(c,{value:"Redux"}),e(c,{value:"MobX"}),e(c,{value:"Cypress"}),e(c,{value:"Junit"}),e(c,{value:"scalatest"}),e(c,{value:"arquillian"})]}),e(n,{children:"This is not a complete list of technologies I have skills to work with, but just the ones most recent/relevant. In a lot of situations I have found that having experience with similar tool is helping to quickly get used to another."}),e(rt,{})]}),lt=()=>{const t=[{title:"Tech",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4 pt-4",children:e(st,{})}),route:"/tech"},{title:"Timeline",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4",children:e(et,{})}),route:"/timeline"},{title:"Open Source",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-1 pb-4",children:e(Ge,{})}),route:"/open-source"},{title:"About",node:e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 px-4 pb-4",children:e(tt,{})}),route:"/about"}],[i,a]=m.exports.useState(0),[o,r]=m.exports.useState(),[h,u]=m.exports.useState();return e(De,{children:e(ct,{currentTab:i,swiper:h,tabs:t,setNavSwiper:r,navSwiper:o,setSwiper:u,setCurrentTab:a})})},ct=({currentTab:t,swiper:i,tabs:a,setNavSwiper:o,navSwiper:r,setSwiper:h,setCurrentTab:u})=>{const b=U(),k=ve(),[E,M]=m.exports.useState(!1),P=ie();m.exports.useEffect(()=>{if(!E){M(!0);return}let f=a[t];console.log("navigating to",f.route),b.pathname!==f.route&&k(f.route)},[t]);const L=()=>{P.hash!==b.hash&&P.setHash(b.hash)},D=f=>{console.log(`nav is ${b.pathname}`);let K=a.findIndex(le=>le.route==b.pathname);K>=0&&t!==K?f==null||f.slideTo(K):L()};return m.exports.useEffect(()=>{D(i)},[i,b]),s(v,{children:[e(at,{currentTab:t,swiper:i,tabs:a,setNavSwiper:o}),e($,{modules:[V,we],shortSwipes:!1,allowTouchMove:!1,spaceBetween:10,controller:{control:r},effect:"coverflow",onSwiper:f=>{h(f)},onSlideChangeTransitionEnd:()=>{L()},onSlideChange:f=>{u(f.activeIndex)},children:a.map(f=>e(X,{children:f.node},f.title))})]})},dt=()=>s("section",{className:"p-6 rounded-tl-3xl bg-gray-800 overflow-x-clip",children:[e("h3",{className:"pt-5 pb-3 text-lg leading-6 font-medium text-gray-900 dark:text-gray-100",children:"Timur Sultanaev is"}),s("ul",{className:"list-disc list-inside text-gray-700 dark:text-gray-200",children:[e("li",{children:"a full-stack developer"}),e("li",{children:", who is focused on complete cycle of delivering cloud-based services"}),e("li",{children:"using DevOps practices and Agile methodology"}),e("li",{children:", with 8 years of working experience"}),e("li",{children:". Currently living in Munich (Germany)"}),e("li",{children:", not looking for a job change"})]}),e(l,{id:"contacts",children:s("div",{className:"mt-3 max-w-prose",children:["About all opportunities, job suggestions, etc, please contact me via LinkedIn only:",e("p",{children:s("a",{href:"https://www.linkedin.com/in/sultanaev-timur",target:"_blank",children:[e(T,{icon:ke})," ","www.linkedin.com/in/sultanaev-timur"]})})]})})]}),ht=i=>{var t=G(i,[]);return e("div",x(y({className:"bg-gray-50 dark:bg-gray-900"},t),{children:s("div",{className:"container mx-auto",children:[s("div",{className:"grid grid-flow-col md:grid-cols-3 grid-cols-2 bg-white dark:bg-gray-800",children:[e("div",{className:"col-start-1 row-span-1 col-span-1 rounded-br-3xl bg-gray-50 dark:bg-gray-900 hidden md:flex justify-center items-center",children:e("div",{className:"h-48 md:transition-[width] w-1 md:w-48",children:e("img",{className:"object-contain h-48 rounded-3xl",src:Ce})})}),e("div",{className:"dark:text-gray-200 md:col-start-2 col-span-2 col-start-1 bg-gray-900",children:e(dt,{})})]}),e("div",{className:"bg-white dark:bg-gray-800 dark:text-gray-200 md:pt-6 md:rounded-tl-3xl",children:e(lt,{})}),e("div",{children:e(B,{to:"#contacts",children:"Contacts"})})]})}))};function ut(){return e("div",{children:e(xe,{children:e(ht,{})})})}Ie.render(e(Se.StrictMode,{children:e(ut,{})}),document.getElementById("root"));
